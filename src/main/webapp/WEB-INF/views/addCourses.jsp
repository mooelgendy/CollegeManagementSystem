        ...
        <div class="container-fluid">
            ...
            <div id="navbar" class="navbar-collapse collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li class="active"><a href="/myapp/viewCourses">Courses</a></li>
    ...
    <div class="form-group">
        <form:form method="post" action="save2">
            <table class="table-striped" class="table">
                <tr>
                    <td>Course Code :</td>
                    <td><form:input path="coId" class="form-control"/></td>
                </tr>
                <tr>
                    <td>Course Name :</td>
                    <td><form:input path="coName" class="form-control"/></td>
                </tr>
                <tr>
                    <td>Course Hours :</td>
                    <td><form:input path="coHours" class="form-control"/></td>
                </tr>
                <tr>
