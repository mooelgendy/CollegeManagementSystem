    ...
    <div class="form-group">
        <form:form method="post" action="save3">
            <table class="table-striped" class="table">
                <tr>
                    <td>Instructor Id :</td>
                    <td><form:input path="insId" class="form-control"/></td>
                </tr>
                <tr>
                    <td>Instructor Name :</td>
                    <td><form:input path="insName" class="form-control"/></td>
                </tr>
                <tr>
                    <td>Instructor Address :</td>
                    <td><form:input path="insAddress" class="form-control"/></td>
                </tr>
                <tr>
                    <td>Instructor Phone :</td>
                    <td><form:input path="insPhone" class="form-control"/></td>
                </tr>
                <tr>
                    <td>Instructor Salary :</td>
                    <td><form:input path="insSalary" class="form-control"/></td>
                </tr>
                <tr>
